...
static gboolean gstreamer_send_bus_call(GstBus *bus, GstMessage *msg,
                                        gpointer data) {
...
GstFlowReturn gstreamer_send_new_sample_handler(GstElement *object,
                                                gpointer user_data) {
...
void gstreamer_send_start_pipeline(GstElement *pipeline, int pipelineId) {
  ...
  g_signal_connect(appsink, "new-sample",
                   G_CALLBACK(gstreamer_send_new_sample_handler), s);
